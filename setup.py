...
setup(
    ...
    author="Red Hat, Inc., LINAGORA",
    author_email="realitix@gmail.com",
    url="https://github.com/realitix/swiftonfile",
    ...
    entry_points={
        ...
        "paste.filter_factory": [
            "sof_constraints=swiftonfile.swift.common."
            "middleware.check_constraints:filter_factory",
        ],
    },
)
